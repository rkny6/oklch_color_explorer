...
function App() {
  ...
  const [shadowBasePoint, setShadowBasePoint] = useState<PathPoint | null>(null)
      ...
      <main className={styles.main}>
        ...
        <section className={styles.canvas}>
          <ColorField
            ...
            shadowBasePoint={shadowBasePoint}
            hiddenColorBasePoint={hiddenColorBasePoint}
